package com.digital.ignite_demo;
...
//			IgniteCache<String, String> cache1 = ignite.getOrCreateCache("dummy1");
//			System.out.println(cache.get("key1"));

			try (IgniteDataStreamer<String, String> ids = ignite.dataStreamer("dummy")) {
				ids.allowOverwrite(true);
				Files.lines(
						Paths.get("/Users/abhayshukla/IdeaProjects/ignite-demo/src/main/resources/result.csv")
	...
	public Ignite ignite() {
		DataStorageConfiguration dsc = getDataStorageConfiguration();
